export default function AnalyticsLoading() {
  return (
    <div
      className="flex min-h-full w-full flex-col items-center justify-center bg-linear-to-br from-blue-50 to-purple-50 px-6 py-16"
      aria-busy="true"
      aria-label="Loading"
    >
      <div className="relative z-10 flex max-w-lg flex-col items-center text-center">
        <div className="mb-8 h-28 w-28 animate-pulse rounded-3xl bg-white/60 shadow-lg ring-1 ring-black/5" />
        <div className="mb-3 h-12 w-56 animate-pulse rounded-lg bg-white/50" />
